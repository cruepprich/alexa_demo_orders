...
function restGet(restCallback) {
    ...
    var headers = {};
    headers = {"RESPONSE":""
              ,"QUERY":"NBR_OF_ORDERS_FOR_CUSTOMER"
              ,"CUSTOMER":"John Dulles"
              ,"DATE":""
            };
...
function onIntent(intentRequest, session, callback) {
    ...
    if (intentName === 'NumberOfOrdersForCustomer') {
        ...
        speechOutput = restGet();

        restGet(function restCallback(speech){
